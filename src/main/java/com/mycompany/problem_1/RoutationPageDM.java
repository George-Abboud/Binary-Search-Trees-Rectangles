 ...
 * @author dell
 */
public class RoutationPageDM extends javax.swing.JFrame {

    /**
     * Creates new form RoutationPageDM
     */
    public RoutationPageDM() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/mycompany/problem_1/DODO DM.png"))); // NOI18N
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        DrawAreaDM d = new DrawAreaDM("Routation");
        d.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RoutationPageDM.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RoutationPageDM().setVisible(true);
            }
        });
    }
