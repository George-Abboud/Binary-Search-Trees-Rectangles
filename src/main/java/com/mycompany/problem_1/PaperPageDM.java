 ...
 * @author dell
 */
public class PaperPageDM extends javax.swing.JFrame {
    
    static List<Node>nodes;
    static List<Node>papers;
    /**
     * Creates new form PaperPageDM
     */
    public PaperPageDM() {
        initComponents();
    }

     public PaperPageDM(Node root ,List<Node>nodes, int totalWidth,List<Node>papers) {
        initComponents();
        this.papers = papers;
        this.nodes = nodes;
        ...
        else
        {
            try {
                ...
                DrawAreaDM d = new DrawAreaDM("Paper" , str,totalWidth);
                d.setVisible(true);
    ...
    private void initComponents() {
        ...
        jButton10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/mycompany/problem_1/SearchDM.png"))); // NOI18N
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        PaperPageInsertDM ppi = new PaperPageInsertDM(nodesNum);
        ppi.setVisible(true);        
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PaperPageDM.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PaperPageDM().setVisible(true);
            }
        });
    }
